...
/**
 * Dto used as a filter for {@link eu.sharedtravel.app.components.travel.model.Travel}
 */
@Data
@AllArgsConstructor
public class TravelFilterDto {
    ...
    @Schema(description = "Timestamp on which the travel will start", type = "string", example = "2022-01-10T16:20:00.000")
    @NotNull
